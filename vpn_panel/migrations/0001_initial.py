    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_class', models.CharField(blank=True, max_length=50, verbose_name='Class')),
                ...
                ('plan_type', models.CharField(default='Basic', max_length=100, verbose_name='Subscription Plan')),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Amount Paid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_ovpn_file', models.BooleanField(default=False, verbose_name='Has OVPN File')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vpn_client', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(blank=True, max_length=150, verbose_name='Full Name')),
                ('student_class', models.CharField(blank=True, max_length=50, verbose_name='Class')),
                ('purchase_date', models.DateTimeField(blank=True, editable=False, verbose_name='Purchase Date')),
                ('expiry_date', models.DateTimeField(blank=True, null=True, verbose_name='Expiry Date')),
                ('plan_type', models.CharField(default='Basic', max_length=100, verbose_name='Subscription Plan')),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Amount Paid')),
                ('is_vpn_enabled', models.BooleanField(default=True)),
